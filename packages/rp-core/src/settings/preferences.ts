...
export interface Preferences {
  ...
  reading: { theme: 'system' | 'light' | 'dark'; fontFamily: 'sans' | 'serif'; fontSize: number; lineHeight: number; maxWidth: number; dialogueColor: DialogueColor; dialogueHighlight: boolean; showAvatars: boolean; showStateCard: boolean }
}
export const DEFAULT_PREFERENCES: Preferences = {
  ...
  reading: { theme: 'system', fontFamily: 'sans', fontSize: 16, lineHeight: 1.85, maxWidth: 640, dialogueColor: 'orange', dialogueHighlight: true, showAvatars: true, showStateCard: true },
}
