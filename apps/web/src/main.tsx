...
import { settingsSearch } from './pages/settings/location.ts'
import { librarySearch } from './pages/library/location.ts'
...
const library = createRoute({ getParentRoute: () => root, path: '/library', validateSearch: librarySearch, component: lazyRouteComponent(() => import('./pages/library.tsx'), 'LibraryPage') })
const settings = createRoute({ getParentRoute: () => root, path: '/settings', validateSearch: settingsSearch, component: lazyRouteComponent(() => import('./pages/settings.tsx'), 'SettingsPage') })
